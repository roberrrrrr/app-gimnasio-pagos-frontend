  ...
  return (
    ...
    <div className="min-h-screen bg-primary py-4 sm:py-8 px-2 sm:px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-4 bg-white p-3 sm:p-4 rounded-xl shadow-sm flex gap-2 border border-neutral-300">
          <input
            type="text"
            ...
            className="flex-1 min-w-0 bg-neutral-50 border-2 border-neutral-300 rounded-lg px-3 py-2 focus:outline-none focus:border-button transition-all font-medium text-sm sm:text-base"
          />
          <button
            onClick={agregarCliente}
            // whitespace-nowrap evita que el texto del botón se rompa en dos líneas
            className="bg-button hover:bg-button-hover text-white font-semibold py-2 px-4 rounded-lg transition-colors text-sm sm:text-base whitespace-nowrap"
          >
            Agregar
          </button>
        </div>
        ...
        <div className="flex flex-col gap-2.5 mt-4">
          ...
          {cargando ? (
            ...
            <>
              ...
              {clientes.length === 0 && (
                <div className="text-center text-neutral-500 py-10 bg-white rounded-xl shadow-sm border border-dashed border-neutral-300 px-4">
